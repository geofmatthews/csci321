...
def main_menu(mygame, level, graphics):
    ...
    while menu_quit != 1:
        ...
        if((keys[pygame.K_RIGHT] or keys[pygame.K_DOWN]) and key_pressed == 0):
            ...
            key_pressed = 1
            mygame.sound_11.play()
        if( keys[pygame.K_LEFT] == 0 and keys[pygame.K_RIGHT] == 0 and keys[pygame.K_UP] == 0 and keys[pygame.K_DOWN] == 0 and keys[pygame.K_ESCAPE] == 0 and keys[pygame.K_RETURN] == 0 and keys[pygame.K_1] == 0 and keys[pygame.K_2] == 0 and keys[pygame.K_3] == 0 and keys[pygame.K_SPACE] == 0):
            key_pressed = 0
        if((keys[pygame.K_RETURN] == 1 or keys[pygame.K_SPACE] == 1 ) and key_pressed == 0):
            menu_quit = 1
            if menu_selection == 0:
                next = "play"
...
def intro(graphics):
    ...
    while menu_quit != 1:
        ...
        if( keys[pygame.K_LEFT] == 0 and keys[pygame.K_RIGHT] == 0 and keys[pygame.K_UP] == 0 and keys[pygame.K_DOWN] == 0 and keys[pygame.K_ESCAPE] == 0 and keys[pygame.K_RETURN] == 0 and keys[pygame.K_1] == 0 and keys[pygame.K_2] == 0 and keys[pygame.K_3] == 0 and keys[pygame.K_SPACE] == 0):
            key_pressed = 0
        if((keys[pygame.K_RETURN] == 1 or keys[pygame.K_RIGHT] == 1 or keys[pygame.K_SPACE] == 1)  and key_pressed == 0):
            menu_quit = 1
