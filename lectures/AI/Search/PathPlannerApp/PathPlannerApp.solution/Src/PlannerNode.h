...
public:
	...
	int compareBestFirst(PlannerNode *second){
		if (heuristicCost < second->heuristicCost){
			return -1;
		
		}else if (heuristicCost > second->heuristicCost){
			return 1;
	...
	int compareDijkstra(PlannerNode *second){
		if (givenCost < second->givenCost){
			return -1;
		
		}else if (givenCost > second->givenCost){
			return 1;
		}
	...
	int compareAStar(PlannerNode *second){
		if (finalCost < second->finalCost){
			return -1;
		
		}else if (finalCost > second->finalCost){
			return 1;
		}
