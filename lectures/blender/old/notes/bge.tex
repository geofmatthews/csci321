...
Blender 2.78.  For the game engine, read:
\begin{description}
\item[Chapter 1, The Blender Interface]
\item[Chapter 2, Working with Viewports]
\item[Chapter 3, Creating/Editing Objects]
\item[Chapter 5, Materials and Textures] 
You can only use image textures in the game engine,
  not any of Blender's generated textures. 
\item[Chapter 10, Animation Basics]
\item[Chapter 15, Child/Parent Relationships]
\item[Chapter 17, Armatures]
\item[Chapter 18, Vertex Shape Keys]
\item[Chapter 22, Game Engine Basics]
\item[Chapter 23, UV Texture Mapping]
\end{description}
\ei
