...
\begin{pspicture}(0,0)(0,0)
\rput(10,-3){\includegraphics[scale=1.5]{computer-space.eps}}
\end{pspicture}
\bi
...
\begin{pspicture}(0,0)(0,0)
\rput(9.5,-4.5){\includegraphics[width=2in]{supermariobros.eps}}
\rput(3,-6){\includegraphics[width=1.5in]{nes.eps}}
\end{pspicture}
\bi
